...
draft: false
cover: "cover.png"
coverCaption: "An illustration that shows the difference between LLMs and humans in the way ther perceive the web. Generated by [SORA](https://openai.com/sora/)"
---
...
![Figure 1: An illustration that shows the difference between LLMs and humans in the way ther perceive the web.](./image.png)
...
![Figure 2: PLAN-AND-ACT System Diagram](./image_1.png)
...
![Figure 3: Synthetic Data Generation Pipeline.](./image_2.png)
...
![Figure 4: Synthetic Data Generation Pipeline - Action Trajectory Generation.](./image_3.png)
...
![Figure 5: Synthetic Data Generation Pipeline - Grounded Plan Generation.](./image_4.png)
...
![Figure 5: Synthetic Data Generation Pipeline - Synthetic Plan Expansion.](./image_5.png)
...
![Table 1: The table shows the task success rate (SR) of PLAN-AND-ACT on WebArena-Lite (Table 1). The approach achieved a state-of-the-art result of 57.58%.](./image_6.png)
...
![Table 2: This table shows that the innovative synthetic data generation pipelines and agentic architectures can make Smaller LLMs outperform better than SOTA LLMs (Table 1, Table 4).](./image_7.png)
